...
namespace DentistApp.Models
{
    public partial class dentistdbContext : DbContext
    {
        ...
        public virtual DbSet<Sessionn> Sessionn { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                //#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                  optionsBuilder.UseMySQL("server=us-cdbr-iron-east-05.cleardb.net;port=3306;database=heroku_d20a76ba102b272;uid=b52a535439180b;password=4c4ae86f");
                //optionsBuilder.UseSqlServer("Server=tcp:us-cdbr-iron-east-05.cleardb.net,3306;Persist Security Info=False;User ID=b52a535439180b;Password=4c4ae86f;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sessionn>(entity =>
            {
